...
// http://stackoverflow.com/a/27078401/815507
    ...
    function SignaturePad(canvas, options) {
        ...
        this.user = 'user' in opts ? opts.user : '';
...
// Public methods
    ...
    /*SignaturePad.prototype.createMatrix = function (x, y, scale, rotate) {
    ...
    SignaturePad.prototype.toWorld = function (x, y) {
        var xx, yy, m;
        m = this.invMatrix;
        xx = x - matrix[4];
        yy = y - matrix[5];
...
// Private methods
    ...
    SignaturePad.prototype._strokeUpdate = function (event) {
        ...
        var y = event.clientY;
        if (valScale) {
            var rect_canvas = this._canvas.getBoundingClientRect();
    ...
    SignaturePad.prototype._reset = function () {
        ...
        //this.invMatrix = [1, 0, 0, 1];   // inverse matrix
        this.points = [];
